...
// 资源监视：仪表盘（与侧栏 HostSidebar 的 Gauge 语义一致）
...
export const ACTIONS = [
  ...
  { kind: 'resource', labelKey: 'capsule.action.resource', Icon: IconGauge },
] as const;
...
export const ACTION_LAYER2 = ['aide', 'search', 'favorite', 'deskpet', 'resource'] as const;
